...
class AuthController {
    ...
    login = async (req: Request, res: Response): Promise<Response> => {
        ...
        if (compare) {
            ...
            return res.send(CreateApiResponse.createApiResponse("login success", { token }, "success"));
        }

        return res.send(CreateApiResponse.createApiResponse("login failed", null, "error"));
    };
